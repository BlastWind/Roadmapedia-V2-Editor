...
import defaultRoadmapThumbnail from './defaultRoadmapThumbnail.jpg'
...
class Graphics extends Component {
    ...
    */
    ...
    async componentDidMount() {
        ...
        var path = "empty for now" || this.props.history.location.pathname
